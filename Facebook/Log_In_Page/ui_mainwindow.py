...
class UiMainWindow(QWidget):
    ...
    def widgets(self):
        ...
        self.lbl_forgot_password = LinkLabel('Forgot Password?', color='#1877f2', font='11pt segoe UI')
        self.lbl_forgot_password.setStyleSheet('color: #1877f2; font: 11pt segoe UI;')
        self.lbl_forgot_password.setCursor(Qt.PointingHandCursor)
        self.lbl_forgot_password.setAlignment(Qt.AlignHCenter)
        self.lbl_forgot_password.setMaximumWidth(150)  # because I want the cursor to only change when hovering directly around the text
        ...
        self.lbl_create_page = LinkLabel('<b>Create a Page</b>', color='black', font='11pt nunito')
        self.lbl_create_page.setStyleSheet('background-color: #f0f2f5; font: 11pt nunito;')
    ...
    def layouts(self):
        ...
        effect.setOffset(0, 4)  # nailed it here but don't know what this means (puts blur on left, right and bottom; excluding top)
        effect.setColor(QColor('#bcbcbc'))
        effect.setBlurRadius(15)
        self.frame.setGraphicsEffect(effect)

        self.frame.setFixedWidth(500)
        self.frame.setFixedHeight(440)
        ...
        self.frame_layout.addSpacing(9)
        ...
        self.frame_layout.addSpacing(25)
